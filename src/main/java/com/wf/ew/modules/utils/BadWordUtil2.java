...
public class BadWordUtil2 {
    public static String filePath =System.getProperty("user.dir");//敏感词库文件路径
    public static Set<String> words;
    public static Map<String,String> wordMap;
    public static int minMatchTYpe = 1;      //最小匹配规则
    public static int maxMatchType = 2;      //最大匹配规则
    static{
        BadWordUtil2.words = readTxtByLine(filePath+"\\src\\main\\java\\com\\wf\\ew\\modules\\utils\\敏感词库.txt");
    ...
    public static void main(String[] args) {
        ...
        String string = "太多的伤感情怀也许只局限于饲养基地法一轮一功tuidang 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
                + "然后法轮功 我们的扮演的角色就是跟随着主人公的喜红客联盟 贪污腐败 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，然后感动就流泪，"
