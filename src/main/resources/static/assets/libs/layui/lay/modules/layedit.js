...
;layui.define(["layer", "form","config"], function (t) {
    "use strict";
    var e = layui.$, i = layui.layer, a = layui.form, config = layui.config, l = (layui.hint(), layui.device()), n = "layedit",
            	...
            	layer.open({
					...
					yes:function(layero,index){
						var arr = $(index).find('iframe')[0].contentWindow.callbackdata();
						 v.call(t, "img", {src: arr.username, alt: arr.username}, a)
...
//                              src: config.base_photo + e.data.src,
//                              alt: e.data.src
//                          }, a)) : i.msg(e.msg || "上传失败")
//                          console.log(config.base_photo + e.data.src);
//                      }
//                  })
//              })
            }, code: function (e) {
        ...
        image: '<i class="layui-icon layedit-tool-image" title="图片" layedit-event="image">&#xe64a;</i>',//自己从文件管理器获取图片
//      image: '<i class="layui-icon layedit-tool-image" title="图片" layedit-event="image">&#xe64a;<input type="file" name="file"></i>',//原有的图片上传
